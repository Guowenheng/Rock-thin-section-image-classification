...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.tuning_mode = tuning_mode
        # tuning_mode_list =[['None', 'None'], ['None', 'None'], ['None', 'None', 'None', 'None', tuning_mode, tuning_mode], [tuning_mode, tuning_mode]]
        tuning_mode_list = [[tuning_mode]*depths[i_layer] if i_layer>=3 else ['None'] * depths[i_layer] for i_layer in range(self.num_layers)]
        if tuning_mode == 'ssf':
...
# @register_model
def swin_tiny_patch4_window7_224(pretrained=False,num_classes: int = 1000,tuning_mode='ssf',**kwargs):#********************************************************************************************
